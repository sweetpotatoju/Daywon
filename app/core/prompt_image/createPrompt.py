...
async def create_prompt():
    ...
    if level == 1:
        ...
        4 - 당신은 초등학교 저학년 학생들에게 금융 지식을 설명해야 합니다. 이 연령대의 학생들은 간단한 개념을 이해할 수 있습니다.
        5 - 대상을 언급하지 마세요.
        """
        ...
        4 - 당신은 초등학교 고학년 학생들에게 금융 지식을 설명해야 합니다. 이 연령대의 학생들은 간단한 개념을 이해할 수 있습니다.
        5 - 대상을 언급하지 마세요.
        """
...
def get_finance_category():
    finance_categories = [
        ...
        "디플레이션", "라퍼곡선", "레그테크", "레버리지 효과", "레버리지비율", "로렌츠곡선", "로보어드바이저", "리디노미네이션", "마스트리히트조약",
