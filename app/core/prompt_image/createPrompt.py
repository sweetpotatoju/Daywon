...
async def create_prompt():
    ...
    if level == 1:
        ...
        5 - 예를 들어, 저축이란 무엇인지,왜 저축이 중요한지 설명할 때는 돼지저금통에 돈을 모으는 이야기처럼 일상적인 상황을 이용하세요.
        """
        ...
        5 - 예를 들어, 저축과 이자의 개념을 설명할 때는 은행에 돈을 맡기면 돈이 어떻게 불어나는지 간단한 수학적 예시를 사용하세요.
        """
        ...
        1 - 공백을 포함한 글자 수를 300자 이내로 작성해주세요.
        2 - 영어가 아닌 한글만 사용해주세요.
        3 - 문장들의 앞 뒤 문맥을 고려해서, 문장의 내용을 초등학교 6학년 학생들의 금융 지식 수준에 맞도록 작성해주세요.
        4 - 당신은 중학생들에게 금융 지식을 설명해야 합니다. 이 연령대의 학생들은 추상적인 개념을 이해할 수 있으며, 실제 생활과 관련된 예시를 통해 더 깊이 있는 내용을 다룰 수 있습니다.
        5 - 예를 들어, 저축과 투자, 예산 관리의 중요성을 설명할 때는 학생들이 용돈을 관리하는 상황을 들어 설명하고, 다양한 저축 상품과 투자 방법에 대해 간단히 소개하세요.
        """
        ...
        1 - 공백을 포함한 글자 수를 300자 이내로 작성해주세요.
        2 - 영어가 아닌 한글만 사용해주세요.
        3 - 문장들의 앞 뒤 문맥을 고려해서, 문장의 내용을 중학교 2학년 학생들의 금융 지식 수준에 맞도록 작성해주세요.
        4 - 당신은 고등학생들에게 금융 지식을 설명해야 합니다. 이 연령대의 학생들은 복잡한 개념을 이해하고, 장기적인 재무 계획에 대해 생각할 수 있습니다.
        5 - 예를 들어, 복리의 개념, 신용 카드 사용의 장단점, 대출의 원리 등을 설명할 때는 구체적인 데이터와 시나리오를 사용하여 실질적인 재무 계획과 위험 관리를 다루세요.
        """
        ...
        1 - 공백을 포함한 글자 수를 300자 이내로 작성해주세요.
        2 - 영어가 아닌 한글만 사용해주세요.
        3 - 문장들의 앞 뒤 문맥을 고려해서, 문장의 내용을 고등학교 3학년 학생들의 금융 지식 수준에 맞도록 작성해주세요.
        4 - 당신은 대학생들에게 금융 지식을 설명해야 합니다. 이 연령대의 학생들은 독립적인 재무 결정을 내릴 준비가 되어 있으며, 고급 금융 개념을 이해할 수 있습니다. 
        5 - 예를 들어, 포트폴리오 다변화, 복리와 단리, 주식과 채권의 차이, 신용 점수의 중요성, 학자금 대출 관리 등을 설명하세요. 구체적인 사례와 데이터를 사용하여 재무 계획을 세우고 위험을 관리하는 방법을 다루세요.
        """
    else:
...
async def create_example_prompt(finance_category):
    api_key = get_api_key()
    model = 'gpt-4'
    system_prompt = """
    다음 조건들을 모두 만족하는 문장을 만들어주세요.
...
def get_finance_category():
    finance_categories = [
        # 금융상품
        "예금", "정기예금", "적금", "자유예금", "단기 예금", "중기 예금", "장기 예금", "수시예금", "보통예금", "기회비용",
        "정기적금", "자유적립식", "연금저축", "목표달성 저축", "주택청약종합저축통장",
        "아이사랑통장", "주식저축", "채권저축", "펀드저축", "외화저축", "생활저축", "월급저축",
        "취업 준비생 저축", "예비 부모 저축", "교육 저축", "외식 저축", "상품 저축", "부동산 저축",
        "대출 담보 저축", "보험 연계 저축", "세금 저축", "청년 적금", "외국인 적금", "연금 보험 저축",
        "청약 자금 적금", "증권연계 적금", "종합저축", "자동이체 적금", "비과세 적금", "연금 저축",
        "이자 종류", "단리이자", "복리이자", "정액이자", "비정액이자", "고정금리", "변동금리",
        "연간이자", "월간이자", "주간이자", "일간이자",

        # 세금 및 공과금
        "소득세", "부가가치세 (VAT)", "법인세", "지방소득세", "지방법인세", "주민세",
        "취득세", "증여세", "상속세", "주택세",
        ...
        "농어업용부대출", "대학자금대출", "주택마이너스대출", "전세자금대출", "신차구입대출",
        "마이너스 통장 대출", "개인신용대출", "사업자대출", "중소기업대출", "법인대출",
        "주택담보대출 연체", "신용대출 연체", "마이너스 통장 대출 연체", "개인신용대출 연체",
        "사업자대출 연체", "중소기업대출 연체", "법인대출 연체", "주택담보대출 상환", "신용대출 상환",
