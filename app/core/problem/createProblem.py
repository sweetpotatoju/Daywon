...
async def create_problem(script, example_script):
    ...
    system_prompt = f"""다음 조건을 모두 만족하는 문장을 만들어주세요.
    1- 10대 수준에서 이해할 수 있게 작성해주세요.
    2- {script}와{example_script}에서 언급한 내용을 이용해주세요.
    3- 언급한 내용을 이용해 금융과 관련된 객관식 문제를 만들어주세요.
    4- 만들어진 문제의 보기는 4개만 작성해주세요.
    5- 정답에 대한 해설도 작성해주세요.
    6- 영어가 아닌 한글로만 작성해주세요.
    ...
    user_prompt = """
        다음 조건을 모두 만족하는 문장을 만들어주세요.
        1- 문제에 대한 정답은 확실하고 정확한 한 가지의 정답을 만들어주세요.
        2-정답이 왜 맞는지에 대해 간단하고 이해하기 쉬운 설명을 해설로 작성해주세요.
        3-영어가 아닌 한글로만 작성해주세요.
        """
